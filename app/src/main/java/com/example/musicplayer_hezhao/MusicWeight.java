...
/**
 * Created by 11120555 on 2020/7/17 11:29
 */
...
public class MusicWeight extends AppWidgetProvider {
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setInt(R.id.play_btn2, "setBackgroundResource", isPlaying ? R.mipmap.pic1 : R.mipmap.pic1);
        if(thumb != null) {
            views.setImageViewBitmap(R.id.image_thumb, thumb);
        }
        else {
            views.setImageViewResource(R.id.image_thumb, R.mipmap.pic1);
        }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        performUpdates(context, "歌曲", false, null);
