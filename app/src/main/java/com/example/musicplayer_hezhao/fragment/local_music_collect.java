...
public class local_music_collect  extends BaseFragment {
    ...
    public void initview(){
        ...
        adapter=new local_music_collect_adapter(vedio_name_list,create_name_list,img_list,getActivity());
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.setAdapter(adapter);
        adapter.setOnItemClickListener(new local_music_collect_adapter.OnItemClickListener(){
            @Override
